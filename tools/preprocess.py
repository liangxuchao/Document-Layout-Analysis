...
def register_publaynet_dataset():
    # register_coco_instances("publaynet_train", {}, "datasets/publaynet_full/train.json", "datasets/publaynet_full/train/")
    # register_coco_instances("publaynet_val", {}, "datasets/publaynet_full/val.json", "datasets/publaynet_full/val/")
    register_coco_instances("publaynet_train", {}, "E:/fyp/publaynet/train.json", "E:/fyp/publaynet/train/")
